...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    topCities: [
      { label: 'Paris', path: '/conciergeries?city=Paris' },
      { label: 'Nice', path: '/conciergeries?city=Nice' },
      { label: 'Lyon', path: '/conciergeries?city=Lyon' },
      { label: 'Marseille', path: '/conciergeries?city=Marseille' },
      { label: 'Bordeaux', path: '/conciergeries?city=Bordeaux' },
      { label: 'Saint-Quentin', path: '/conciergeries?city=Saint-Quentin' },
    ],
    resources: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+33768661948" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center gap-2">
